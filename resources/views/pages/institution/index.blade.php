...
<div class="page-heading">
    ...
    <a href="{{ route('admin.institution.create') }}" class="btn btn-primary mb-3"><span class="bi bi-plus-circle"></span> Create New</a>
                            ...
                            @foreach ($institutions as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn btn-denger btn-sm me-1" onclick="handleDestroy(`{{ route('admin.institution.destroy', $item->id) }}`)">
