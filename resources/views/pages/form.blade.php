        ...
        <div class="row justify content center">
            <div class="col-md-9">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <p>Silahkan masukkan data kamu sebagai tamu, pada form dibawah: </p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-grup mb-3">
                                        ...
                                        <input type="text" name="form" id="form" value="{{ old('form') }}" class="form-control @error('form') is-invalid @enderror">
                        ...
                        <button type="submit" class="btn btn-primary">Submit <span class="bi bi-send ms-2"></span></button>
                        </form>
                    </div>
                </div>
            </div>
